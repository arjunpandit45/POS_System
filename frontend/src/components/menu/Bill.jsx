...
const handlePlaceOrder = async () => {
    ...
    if( !paymentMethod){
      enqueueSnackbar("Pleace select a payment method!" ,  {variant : "warning"});
      return;
    }
      ...
      try {
        ...
        const options = {
          ...
          handler: async function (response) {
            ...
            // send the data for addOrder Api 
            setTimeout(() => {
  ...
  return (
    <>
      <div className='flex items-center justify-between px-5 mt-0.5 '>
        <p className='text-xs text-[#ababab] font-medium mt-2 '>Itema({cartData.length})</p>
      ...
      <div className='flex items-center gap-3 px-5 mt-3 '>
        <button className={`bg-[#1f1f1f] px-4 py-2 w-full rounded-lg text-[#ababab] font-semibold 
      ...
      <div className='flex items-center gap-3 px-5 mt-2 '>
        ...
        <button className='bg-[#f6b100] px-4 py-2 w-full rounded-lg text-[#1f1f1f] font-semibold text-lg '
